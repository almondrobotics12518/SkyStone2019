...
public class Intake {
    ...
    public static double RIGHT_OPEN_POS = 0.15;
    public static double RIGHT_CLOSE_POS = 0.4;

    public static double LEFT_OPEN_POS = 0.85;
    public static double LEFT_CLOSE_POS = 0.55;
